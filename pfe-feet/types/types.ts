...
export const symptomCategoryMapping: SymptomCategoryMapping = {
  ...
  [Symptom.BLOCKED_NOSE]: [
    SymptomCategory.MISCELLANEOUS,
    SymptomCategory.CIRCULATORY,
  ],
  ...
  if (categories && categories.length > 0) {
    ...
    switch (firstCategory) {
      case SymptomCategory.MUSCULAR:
        return 'border-[#E1529F] border-[1px]';
      case SymptomCategory.DIGESTION:
        return 'border-[#ABE152] border-[1px]';
      case SymptomCategory.CIRCULATORY:
        return 'border-[#E15252] border-[1px]';
      case SymptomCategory.HYDRATION:
        return 'border-[#528BE1] border-[1px]';
      case SymptomCategory.MISCELLANEOUS:
        return 'border-[#508C97] border-[1px]';
      default:
        return undefined;
    }
  }
